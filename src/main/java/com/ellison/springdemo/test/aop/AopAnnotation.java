package com.ellison.springdemo.test.aop;
...
public class AopAnnotation {
    ...
    @Pointcut("execution(public * com.ellison.springdemo.service.*.*(..))")
    public void serviceAdvice(){}

    @Pointcut("execution(public * com.ellison.springdemo.service.*.method1(..))")
    public void method1(){}

    @Pointcut("execution(public * com.ellison.springdemo.service.StudentService.method2(..))")
    public void method2(){}
