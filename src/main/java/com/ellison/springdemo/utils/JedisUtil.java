...
public class JedisUtil {
    ...
    public void init() {
        if (pool == null) {
            ...
            pool = new JedisPool(config, redisConfigInfo.getIp(), redisConfigInfo.getPort(), 10000, redisConfigInfo.getAuth());
        }
    }

    @Autowired
    public JedisUtil(RedisConfigInfo redisConfigInfo) {
